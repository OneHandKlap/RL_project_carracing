...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        if t > self.nsteps:
            ...
            #self.epsilon = self.eps_begin - (np.abs(self.eps_end - self.eps_begin)) * min(np.float32(t) / self.nsteps, 1.0)
            self.epsilon = self.eps_begin - (np.abs(self.eps_end - self.eps_begin)) * np.float32(t) / self.nsteps
        ##############################################################
        ######################## END YOUR CODE ############## ########
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        if self.epsilon - np.random.random() > 0:

...
class QN(object):
    ...
    def train(self, exp_schedule, lr_schedule):
        ...
        while t < self.config.nsteps_train:
            ...
            #while True:
            playing_time = 0 # time control for each episode
            while playing_time < self.config.playing_time:
                playing_time += 1
                t += 1
                last_eval += 1
                last_record += 1
                ...
                new_state, reward, done, info = self.env.step(self.env.action_space[action])
    ...
    def evaluate(self, env=None, num_episodes=None):
        ...
        for i in range(num_episodes):
            ...
            while True:
                ...
                # perform action in env
                new_state, reward, done, info = env.step(self.env.action_space[action])
